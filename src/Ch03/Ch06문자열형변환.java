...
//		System.out.println("문자열1" + 2);				//문자열 + 숫자 -> 숫자를 문자열로 해석, 단순 연결
//		System.out.println("문자열1" + ',' + '!');
//		System.out.println(',' + '!');					//문자 + 문자 -> 문자를 숫자로 해석
...
//		
//		int n1 = Integer.parseInt("10");			//웹개발코드시 폼으로부터 전달받은 값은 가 문자열임
