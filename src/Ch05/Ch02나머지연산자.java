...
//		while (true) {
//			System.out.println(rnd.nextInt(5)); //N % 5 와 동일 (0 ~ 4)
//			Thread.sleep(500);
//		}
...
//		System.out.println("왼쪽 끝 4자리 : " + (num / 10));
		...
		//정수 하나를 입력받아 거꾸로 저장해보세요 %,/ 연산 동시이용할 것
		//예
		...
		//문제
		//정수값 3개를 입력받아서 세수의 합을 구합니다.
		//그 합이 짝수이면서 5의 배수면 '참입니다'를 출력 아니면 '거짓입니다'를 출력하세요
		//조건식에 %, && 연산기호를 사용랍니다
		//삼항연산자를 사용합니다
